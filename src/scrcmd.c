...
static PokemonPortrait *FieldSystem_LoadPokemonPortrait(int heapID, FieldSystem *fieldSystem, int portraitLocationID, int portraitID)
{
    ...
    PokemonPortrait *pokemonPortrait = Heap_Alloc(heapID, sizeof(PokemonPortrait));
...
static BOOL ScrCmd_ShowGalleryPortrait(ScriptContext *ctx)
{
    ...
    *pokemonPortrait = FieldSystem_LoadPokemonPortrait(HEAP_ID_FIELD2, ctx->fieldSystem, PORTRAIT_LOCATION_JUBILIFE_TV_GALLERY, portraitID);
...
static BOOL ScrCmd_ShowLobbyPortrait(ScriptContext *ctx)
{
    ...
    *pokemonPortrait = FieldSystem_LoadPokemonPortrait(HEAP_ID_FIELD2, ctx->fieldSystem, PORTRAIT_LOCATION_CONTEST_HALL_LOBBY, portraitID);
...
static BOOL ScrCmd_LoadDoorAnimation(ScriptContext *ctx)
{
    u16 x1 = ScriptContext_ReadHalfWord(ctx);
    u16 z1 = ScriptContext_ReadHalfWord(ctx);
    u16 x2 = ScriptContext_GetVar(ctx);
    u16 z2 = ScriptContext_GetVar(ctx);
