...
static u16 ScriptContext_LoadAndOffsetID(FieldSystem *fieldSystem, ScriptContext *ctx, u16 scriptID)
{
    ...
    } else if (retScriptID >= SCRIPT_ID_OFFSET_POKEDEX_COMMON) {
        ScriptContext_Load(fieldSystem, ctx, scripts_pokedex_common, TEXT_BANK_POKEDEX_COMMON);
        retScriptID -= SCRIPT_ID_OFFSET_POKEDEX_COMMON;
