...
#include "res/text/bank/menu_entries.h"
    ...
    CommonScriptEntry CommonScript_HandleSignpostInput
...
DefCommonScript CommonScript_Unk0A:
    End

DefCommonScript CommonScript_Unk07:
    End

DefCommonScript CommonScript_Unk02:
...
DefCommonScript CommonScript_HandleSignpostInput:
...
DefCommonScript CommonScript_Unk01:
    Call _0356
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk03:
    LockAll
...
DefCommonScript CommonScript_Unk04:
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    WaitABPress
    FadeScreen 6, 1, 0, 0
...
DefCommonScript CommonScript_Unk05:
...
DefCommonScript CommonScript_Unk22:
    Message 20
    WaitABPress
    CloseMessage
    End

DefCommonScript CommonScript_Unk06:
...
DefCommonScript CommonScript_Unk08:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
...
DefCommonScript CommonScript_Unk09:
    Call _0723
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk0B:
    End

DefCommonScript CommonScript_Unk0C:
    Call _091D
    Message 109
    WaitABXPadPress
    ReturnCommonScript
...
DefCommonScript CommonScript_Unk2E:
    Call _091D
    Message 128
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk0D:
    Call _0944
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk0E:
    Call _0966
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk0F:
    Call _099F
    Message 31
    WaitABXPadPress
    ReturnCommonScript
...
DefCommonScript CommonScript_Unk2F:
    Call _099F
    Message 127
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk24:
    Call _09D9
    Message 31
    WaitABXPadPress
    ReturnCommonScript
...
DefCommonScript CommonScript_Unk2D:
    Call _09D9
    Message 127
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk10:
    Call _09FF
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk2C:
    Call _0A3E
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk11:
    Call _0BE7
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk12:
    LockAll
...
_0F62:
    PlayFanfare SEQ_SE_DP_PC_LOGIN
    CallCommonScript PokedexCommon_CheckPC
    GoTo _0C1C
...
DefCommonScript CommonScript_Unk16:
    End

DefCommonScript CommonScript_Unk17:
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
    OpenSealCapsuleEditor
    FadeScreen 6, 1, 1, 0
...
DefCommonScript CommonScript_Unk13:
    Message 37
    ReturnCommonScript
    End

DefCommonScript CommonScript_Unk14:
    LockAll
...
DefCommonScript CommonScript_Unk15:
    LockAll
    FadeScreen 6, 1, 1, 0
    WaitFadeScreen
    SetPlayerState 0x100
...
DefCommonScript CommonScript_Unk18:
    End

DefCommonScript CommonScript_Unk19:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
...
DefCommonScript CommonScript_Unk1A:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FacePlayer
    ScrCmd_20C
...
DefCommonScript CommonScript_Unk1B:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FacePlayer
    Message 67
...
DefCommonScript CommonScript_Unk1C:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FacePlayer
    Message 70
...
DefCommonScript CommonScript_Unk1D:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FacePlayer
    Message 71
...
DefCommonScript CommonScript_Unk1E:
...
DefCommonScript CommonScript_Unk1F:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    Message 76
    WaitABPress
...
DefCommonScript CommonScript_Unk20:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    Message 79
    WaitABPress
...
DefCommonScript CommonScript_Unk21:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FacePlayer
    ScrCmd_0A5
...
DefCommonScript CommonScript_Unk23:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
    FacePlayer
    Message 82
...
DefCommonScript CommonScript_Unk26:
    Call _13C8
    ReturnCommonScript
    End
...
DefCommonScript CommonScript_Unk25:
    End

DefCommonScript CommonScript_Unk27:
    LockAll
    GetCurrentMapID VAR_0x8004
...
DefCommonScript CommonScript_Unk28:
    StopMusic 0
...
DefCommonScript CommonScript_Unk2A:
    StopMusic 0
    ScrCmd_057 SEQ_THE_RIV
    ReturnCommonScript
    End

DefCommonScript CommonScript_Unk30:
    StopMusic 0
    ScrCmd_057 SEQ_TSURETEKE
    ReturnCommonScript
    End

DefCommonScript CommonScript_Unk37:
    StopMusic 0
    ScrCmd_057 SEQ_PL_HANDSOME
    ReturnCommonScript
    End

DefCommonScript CommonScript_Unk29:
    FadeOutBGM 0, 30
    StopMusic 0
    PlayDefaultMusic
    ReturnCommonScript
...
DefCommonScript CommonScript_Unk32:
    FadeScreen 6, 1, 0, 0
    WaitFadeScreen
...
DefCommonScript CommonScript_Unk33:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
...
DefCommonScript CommonScript_Unk34:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
...
DefCommonScript CommonScript_Unk35:
    PlayFanfare SEQ_SE_CONFIRM
    LockAll
...
DefCommonScript CommonScript_Unk36:
...
DefCommonScript CommonScript_Unk39:
    Message 130
    WaitABXPadPress
    CloseMessage
    ReleaseAll
