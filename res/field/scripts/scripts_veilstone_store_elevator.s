...
VeilstoneStoreElevator_SelectFloorB1:
    ...
    GetFloorsAbove VAR_ELEVATOR_FLOORS_ABOVE
    SetWarpEvent MAP_HEADER_VEILSTONE_STORE_B1F, 1, 18, 2, 1
...
VeilstoneStoreElevator_SelectFloor1:
    WaitTime 1, VAR_RESULT
    GetFloorsAbove VAR_ELEVATOR_FLOORS_ABOVE
    SetWarpEvent MAP_HEADER_VEILSTONE_STORE_1F, 2, 18, 2, 1
...
VeilstoneStoreElevator_SelectFloor2:
    WaitTime 1, VAR_RESULT
    GetFloorsAbove VAR_ELEVATOR_FLOORS_ABOVE
    SetWarpEvent MAP_HEADER_VEILSTONE_STORE_2F, 2, 18, 2, 1
...
VeilstoneStoreElevator_SelectFloor3:
    WaitTime 1, VAR_RESULT
    GetFloorsAbove VAR_ELEVATOR_FLOORS_ABOVE
    SetWarpEvent MAP_HEADER_VEILSTONE_STORE_3F, 2, 18, 2, 1
...
VeilstoneStoreElevator_SelectFloor4:
    WaitTime 1, VAR_RESULT
    GetFloorsAbove VAR_ELEVATOR_FLOORS_ABOVE
    SetWarpEvent MAP_HEADER_VEILSTONE_STORE_4F, 2, 18, 2, 1
...
VeilstoneStoreElevator_SelectFloor5:
    WaitTime 1, VAR_RESULT
    GetFloorsAbove VAR_ELEVATOR_FLOORS_ABOVE
    SetWarpEvent MAP_HEADER_VEILSTONE_STORE_5F, 1, 18, 2, 1
