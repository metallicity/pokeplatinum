...
BOOL SaveData_IsGalleryPortraitFilled(const UnkStruct_0202A750 *param0, int param1);
BOOL SaveData_IsLobbyPortraitFilled(const UnkStruct_0202A750 *param0, int param1);
